...
def fix_wrong_shank_NP2(cluster_info, ChanMap):
    ...
    Args:
        cluster_info (path): path to folder that contains cluster_info.tsv file. 
                             Generated by Jennifer Colonell script for ephys analysis
        ChanMap (path): path to kilosort channel map. Requires running SGLXMetaToCoords.py from: 
...
def get_brain_regions(cluster_info, histology, neuropixels_20=True):
    ...
    Args:
        cluster_info (path): path to folder that contains cluster_info.tsv file. 
                             Generated by Jennifer Colonell script for ephys analysis
        histology (path): path to folder containing herbs probe X.pkl files
...
def neurons_per_structure(all_good_clusters, save_path, plot=True):
    ...
    Args:
        ...
        save_path (path): path to a folder
